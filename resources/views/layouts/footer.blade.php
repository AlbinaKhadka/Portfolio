...
<footer class="ftco-footer ftco-section">
            ...
            {{-- <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <ul class="ftco-footer-social list-unstyled mt-2">
                        <li class="ftco-animate"><a href="{{setting('social.Twitter')}}"><span class="fa fa-twitter"></span></a></li>
                        <li class="ftco-animate"><a href="{{setting('social.Linkedin')}}"><span class="fa fa-Linkedin"></span></a></li>
                        <li class="ftco-animate"><a href="{{setting('social.Github')}}"><span class="fa fa-Github"></span></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <!-- Keep the Google Maps API script as it is -->
